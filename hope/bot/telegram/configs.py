...
MESSAGES = {
    ...
    "supported_admin_message":"لطفا یکی از پشتیبان ها را انتخاب کنید ",
    "end_support_message":"گفتگو به پایان رسید",
    "supported_message_":"""متن خود را ارسال کنید
لطفا فقط پیغام خود را در قالب یک مسیج ارسال کنید
⛔️ توجه داشته باشید برای اینکه با پشتیبانی چت کنید حتما حتما در همین مرحله باقی بمانید و دکمه "🔚 پایان گفتگو"" را نزنید. 
بعد از پایان گفتگو لطفا دکمه "/start" یا پایان گفتگو را بزنید \n‌‌‌‌‌""",
